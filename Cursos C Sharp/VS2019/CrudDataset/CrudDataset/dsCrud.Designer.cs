...
namespace CrudDataset.dsCrudTableAdapters {
    ...
    public partial class peopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [CrudWindowsForm].[dbo].[people] WHERE (([id] = @Original_id) AND ((@" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [CrudWindowsForm].[dbo].[people] ([name], [age]) VALUES (@name, @age)" +
                ";\r\nSELECT id, name, age FROM people WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [CrudWindowsForm].[dbo].[people] SET [name] = @name, [age] = @age WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)));
SELECT id, name, age FROM people WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CrudDataset.Properties.Settings.Default.CrudWindowsFormConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, age  FROM CrudWindowsForm.dbo.people";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO [CrudWindowsForm].[dbo].[people] ([name], [age]) VALUES (@name, @age)" +
                ";";
            ...
            this._commandCollection[2].CommandText = "UPDATE [CrudWindowsForm].[dbo].[people] SET name = @name, age = @age WHERE id = @" +
                "id ";
            ...
            this._commandCollection[3].CommandText = "SELECT id, name, age  FROM CrudWindowsForm.dbo.people where id=@id";
            ...
            this._commandCollection[4].CommandText = "DELETE FROM [CrudWindowsForm].[dbo].[people] WHERE id = @id";
        ...
        public virtual int Add(string name, global::System.Nullable<int> age) {
        ...
        public virtual int Edit(string name, global::System.Nullable<int> age, int id) {
